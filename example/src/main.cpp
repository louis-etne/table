...
int main()
{
    std::vector<std::vector<std::string>> values{{"88", "\033[33m\033[01m0x7ffee784e96c\033[0m", "0x7ffee784e960", "0x7ffee784e96c", "88"},
    ...
    table::Table table{values, headers};
    ...
    // You can use ANSI escape codes for stylizing your values or headers.
